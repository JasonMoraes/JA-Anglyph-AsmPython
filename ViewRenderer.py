...
class ViewRenderer:
    ...
    def render(self):
        ...
        if event == 'Select Image':
            ...
            dim = (int(self.windowDimensions[1]/2), int(self.img.shape[1]/self.windowDimensions[0]/2 * self.img.shape[0]))
        ...
        if event == 'Anaglify':
            ...
            dim = (int(self.windowDimensions[1]/2), int(data.shape[1]/self.windowDimensions[0]/2 * data.shape[0]))
